            ...
            <article className="max-w-4xl mx-auto">
                    ...
                    <div className="glass-card rounded-2xl p-6">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                { icon: '✨', text: 'Transforms them into clean, organized study notes using AI' },
                                { icon: '📊', text: 'Shows real-time progress as each lecture is processed' },
                                { icon: '📜', text: 'Tracks your generation history for easy reference' },
                                { icon: '📦', text: 'Downloads everything as a structured ZIP file' },
                            ].map((item, i) => (
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        {/* Customization */}
                        <div className="glass-card rounded-2xl p-6 hover:shadow-lg transition-shadow md:col-span-2">
                            <div className="flex items-center gap-3 mb-4">
                                <span className="text-2xl">⚙️</span>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Complete Customization</h3>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
                                Make the notes truly yours with powerful settings:
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 text-sm text-gray-600 dark:text-gray-400">
                                <div className="flex items-center gap-2">
                                    <span className="text-indigo-500">✨</span>
                                    <span>Edit the AI Prompt</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-indigo-500">📑</span>
                                    <span>Single File or Chapter-based</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-indigo-500">🔒</span>
                        ...
                        <div className="glass-card rounded-2xl p-6 hover:shadow-lg transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                <span className="text-2xl">📊</span>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Real-Time Progress</h3>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
                                Watch your notes being generated in real-time:
                            </p>
                            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                <li>✅ Live status for each lecture</li>
                                <li>✅ Caption fetch & LLM processing status</li>
                                <li>✅ Error visibility with fallback content</li>
                            </ul>
                        </div>
                        ...
                        <div className="glass-card rounded-2xl p-6 hover:shadow-lg transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                <span className="text-2xl">📜</span>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Generation History</h3>
                            </div>
                            <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
                                Track all your past generation sessions:
                            </p>
                            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                <li>✅ View past sessions anytime</li>
                                <li>✅ See download filenames</li>
                                <li>✅ Expandable lecture details</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section className="glass-card rounded-2xl p-8 text-center bg-gradient-to-br from-indigo-500/10 to-purple-500/10">
                    ...
                    {/* Docker Command */}
                    <div className="bg-gray-900 rounded-xl p-4 mb-6 text-left overflow-x-auto">
                        <div className="text-xs text-gray-400 mb-2">🐳 Quick Start with Docker</div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="https://hub.docker.com/r/vikas9dev/notesynth"
                            target="_blank"
                        ...
                        <Link href="/" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border-2 border-gray-200 dark:border-slate-600 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-slate-700 transition-all">
